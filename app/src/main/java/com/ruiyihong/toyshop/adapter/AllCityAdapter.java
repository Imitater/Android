...
public class AllCityAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public AllCityAdapter(Context context, List<SortModel>  list) {
    ...
    public int getSectionForPosition(int position) {
      //  LogUtil.e("==SortLetters=="+list.get(position).getSortLetters().charAt(0));
        String sortLetters = list.get(position).getSortLetters();
