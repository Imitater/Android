...
public class JifenDuihuanToyRvAdapter extends RecyclerView.Adapter<JifenDuihuanToyRvAdapter.MyViewHolder> {
    private final Context context;
    private List list;
    private OnItemClickListener itemListener;

    public JifenDuihuanToyRvAdapter(Context context, List list){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_rv_jifen_duihuan_toy,null));
    }
