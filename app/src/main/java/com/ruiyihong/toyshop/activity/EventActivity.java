...
public class EventActivity extends BaseActivity {
    ...
    @InjectView(R.id.tv_more_benefit)
    TextView mTvMoreBenefit;
    @InjectView(R.id.tv_more_out)
    TextView mTvMoreOut;
    @InjectView(R.id.tv_more_qinzi)
    TextView mTvMoreQinzi;
    ...
    private void initBenefit(RecyclerView rv, String body, int drawable) {
        ...
        rvAdapter.setOnItemClickListener(new EventRvAdapter.onRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                Intent intent = new Intent(EventActivity.this, BenefitActivity.class);
    ...
    protected void initEvent() {
        mTvMoreBenefit.setOnClickListener(this);
        mTvMoreYouhui.setOnClickListener(this);
        mTvMoreOut.setOnClickListener(this);
        mTvMoreQinzi.setOnClickListener(this);
    ...
    protected void processClick(View v) throws IOException {
        ...
        switch (v.getId()) {
            case R.id.tv_more_youhui:
                intent = new Intent(this, LimitedTimeActivity.class);
                break;
            case R.id.tv_more_benefit:
                intent = new Intent(this, MoreBenefitActivity.class);
                intent.putExtra("class",MoreBenefitActivity.TYPE_BENEFIT);
                break;
            case R.id.tv_more_out:
                intent = new Intent(this, MoreBenefitActivity.class);
                intent.putExtra("class",MoreBenefitActivity.TYPE_OUT);
                break;
            case R.id.tv_more_qinzi:
                intent = new Intent(this, MoreBenefitActivity.class);
                intent.putExtra("class",MoreBenefitActivity.TYPE_QINZI);
                break;
