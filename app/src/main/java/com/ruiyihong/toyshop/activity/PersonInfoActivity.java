...
public class PersonInfoActivity extends BaseActivity {
	...
	private void parseVipData(String vipData) {
		...
		if(TextUtils.isEmpty(vkind)){
			...
			tvPersonalVipLevel2.setText(vkind);
		}else{
...
//		tvPersonSubmit.requestFocus();
	...
	private void parse(String data) {
		...
		Picasso.with(this).load(headUrl).placeholder(R.mipmap.personinfo_head_icon).error(R.mipmap.personinfo_head_icon
		).fit().into(ivPersonHeadImage);
	...
	protected void initEvent() {
		...
		//llPersonLastmoney.setOnClickListener(this);
	}
	...
	private void submitOther() {
		final String nickName = etPersonNickName.getText().toString().trim();
		...
		LogUtil.e("宝宝性别=" + sex);
		LogUtil.e("昵称=" + nickName);
		LogUtil.e("宝宝生日=" + birthday);
		LogUtil.e("uid=" + userBean.uid);
					...
					if (result != null) {
						...
						runOnUiThread(new Runnable() {
							...
							public void run() {
								...
								PersonInfoActivity.this.finish();
								//修改sp存储的昵称
//								String str = SPUtil.getString(PersonInfoActivity.this, AppConstants.SP_LOGIN, "");
...
//									jsonObject.put("yhniche",nickName);
//									str = jsonObject.toString();
//									SPUtil.setString(PersonInfoActivity.this,AppConstants.SP_LOGIN,str);
