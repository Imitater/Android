...
import com.ruiyihong.toyshop.adapter.JifenDuihuanToyRvAdapter;
...
/**
 * Created by 李晓曼 on 2017/8/13.
 */

public class JifenDuihuanToyActivity extends BaseActivity {
    private static final String BUFFER_JIFEN_DUIHUAN_TOY = "buffer_jifen_duihuan_toy";
    private static final int TYPE_DUIHUAN_TOY = 0;
    ...
    private int page = 1;
    private JifenDuihuanToyRvAdapter rvAdapter;
    private Handler handler = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case TYPE_DUIHUAN_TOY:
                    initRvDuihuan();
                    break;
                case MSG_REFRESH:
                    refresh();
    ...
    protected void initData() {
        ...
        String buffer = SPUtil.getString(this, BUFFER_JIFEN_DUIHUAN_TOY, "");
        ...
        if (NetWorkUtil.isNetWorkAvailable(this)) {
            postNet(AppConstants.JIFEN_DUIHUAN_TOY, new HashMap<String, Object>(), TYPE_DUIHUAN_TOY);
        } else {
                    ...
                    if (!TextUtils.isEmpty(result)) {
                        ...
                        if (bean != null && bean.getData() != null && bean.getData().size() > 0) {
                            if (type == MSG_LOAD_MORE) {
                                ...
                                dataList = bean.getData();
                                SPUtil.setString(JifenDuihuanToyActivity.this, BUFFER_JIFEN_DUIHUAN_TOY, result);
                            }
    ...
    private void initRvDuihuan() {
        ...
        rvAdapter = new JifenDuihuanToyRvAdapter(this, list);
        mRvJifenDuihuan.setAdapter(rvAdapter);
        rvAdapter.setOnItemClickListener(new JifenDuihuanToyRvAdapter.OnItemClickListener() {
            @Override
            public void itemClick(View v, int position) {
                JifenDuihuanBean.DataBean dataBean = list.get(position);
                Intent intent = new Intent(JifenDuihuanToyActivity.this, DetailActivity.class);
    ...
    protected void initEvent() {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                if (NetWorkUtil.isNetWorkAvailable(JifenDuihuanToyActivity.this)) {
                    //下拉刷新
                    Map<String, Object> map = new HashMap();
                    postNet(AppConstants.JIFEN_DUIHUAN_TOY, map, MSG_REFRESH);
                } else {
                    mSmartRefreshLayout.finishRefresh(0);
                    ToastHelper.getInstance().displayToastShort("请检查网络");
                }
        ...
        mSmartRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                if (NetWorkUtil.isNetWorkAvailable(JifenDuihuanToyActivity.this)) {
                    ...
                    page++;
                    map.put("page", page);
                    postNet(AppConstants.JIFEN_DUIHUAN_TOY_UPLOAD, map, MSG_LOAD_MORE);
                } else {
                    mSmartRefreshLayout.finishLoadmore(0);
                    ToastHelper.getInstance().displayToastShort("请检查网络");
                }
