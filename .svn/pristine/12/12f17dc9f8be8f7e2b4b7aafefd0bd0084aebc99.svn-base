...
public class CommonLoadingView extends FrameLayout {
    ...
    public void  setOnRefreshPagerListener(OnRefreshPageListener listener){
    ...
    public void load(){
        ...
        ImageView iv = loadingView.findViewById(R.id.refresh_iv);
    ...
    public void loadError(){
        ...
        if(listener!=null){
            loadingErrorView.findViewById(R.id.iv_refresh_page).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.Refresh();
                    LogUtil.e("refresh click");
                }
            });
        }
    }
