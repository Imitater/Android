...
import static com.fire.photoselector.models.PhotoSelectorSetting.ITEM_POSITION;
...
public class PhotoSelectorActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvCancel1 = (TextView) findViewById(R.id.tv_select_cancel1);
        ...
        item_position = intent.getIntExtra(ITEM_POSITION, -1);//add by self
    ...
    private void changeOKButtonStatus() {
        if (SELECTED_PHOTOS.size() == 0) {
            ...
            btPreviewImage.setTextColor(getResources().getColor(R.color.buttonnormal));
        }
